...
const App = () => (
  <div>
    <div className='container'>
      <div className='jumbotron'>
        <h1 className='text-center'>The Life and Times of Kurt Gödel</h1>
        <img className='img-responsive center-block'  src={'https://upload.wikimedia.org/wikipedia/en/4/42/Kurt_g%C3%B6del.jpg'} alt='kurtgodel.jpg' title='Kurt Godel had some baller-ass glasses.' />
        <p className='text-center'>Kurt Friedrich Godel (1906 - 1978)</p>
        <div className='row'>
          <div className='col-md-2'></div>
        </div>
